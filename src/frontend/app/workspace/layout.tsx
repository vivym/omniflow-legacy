...
const navigation = [
  {
    ...
    icon: BeakerIcon,
    subNavigations: [
      { name: '我的工作流', href: '/workspace/workflow/mine' },
      { name: '模板市场', href: '/workspace/workflow/template' },
    ],
  },
  {
    name: '数据中心',
                      ...
                      <li key={item.name}>
                        ...
                        >
                          ...
                          {item.subNavigations.length > 0 && (
                            isActive(item.href)
                              ? <ChevronDownIcon className="h-5 w-5 shrink-0 ml-auto" aria-hidden="true" />
                              : <ChevronLeftIcon className="h-5 w-5 shrink-0 ml-auto" aria-hidden="true" />
                          )}
                        </a>
                        {/* TODO: Add animation */}
                        {isActive(item.href) && item.subNavigations.length > 0 && (
                                ...
                                <a
                                  ...
                                  className={classNames(
                                    isActive(subItem.href)
                                      ? 'bg-gray-50 text-indigo-600'
                                      : 'text-gray-700 hover:text-indigo-600 hover:bg-gray-50',
                                    'group flex pl-11 rounded-md p-2 text-sm leading-6 font-semibold'
                                  )}
                                >
                                  {subItem.name}
                                </a>
